...
Public Class Rapport
    ...
    Private Function Connect() As Boolean
        ...
        Try
            ...
            dbMultivers.ConnectionString = String.Format("DSN=Unit 4 Multivers;DB={0};UID={1};PWD={2}", System.Configuration.ConfigurationManager.AppSettings.Get("Administratie") & "", "", "")
            dbMultivers.Open()
